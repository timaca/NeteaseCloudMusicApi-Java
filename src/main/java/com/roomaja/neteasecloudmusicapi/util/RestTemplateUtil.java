...
public class RestTemplateUtil {
     ...
     * @return
     */
    public static ResponseEntity<JSONObject> postWeapi(String params, String encSecKey, String url,
            Map<String, String> cookies, RestTemplate restTemplate) {
        ...
        return new ResponseEntity<JSONObject>(JSON.parseObject(resp.getBody()), resp.getHeaders(),
                resp.getStatusCode());
    }
     ...
     * @return
     */
    public static ResponseEntity<JSONObject> postLinuxapi(String eparams, String url, Map<String, String> cookies,
